...
parser.add_argument("--xfile", type=str, default="./train_output/snclr/vits_small_300_40w/lin_cls/fea.txt", help="file name of feature stored")
parser.add_argument("--yfile", type=str, default="./train_output/snclr/vits_small_300_40w/lin_cls/tgt.txt", help="file name of label stored")
...
if __name__ == "__main__":
    ...
    path_out = "./train_output/snclr/vits_small_300_40w/lin_cls/tsne.png"
    X = np.loadtxt(xfile)
    X = torch.Tensor(X)
